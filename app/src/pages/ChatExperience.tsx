...
export function ChatExperience() {
  ...
  const animConfig = useDialKit("Inline Config", {
    ...
    button: {
      stiffness: [500,  50,  600,  1    ],
      damping:   [50,   5,   60,   0.5  ],
      mass:      [0.2,  0.1, 3,    0.05 ],
      staggerEnter: [0.12, 0,  0.3,  0.005],
      staggerExit:  [0.06, 0,  0.3,  0.005],
    },
    addButton: {
      duration:       [0.2, 0.1, 2, 0.01],
      visualDuration: [0.18, 0.1, 2, 0.01],
      bounce:         [0.2, 0,   1, 0.01],
    },
    enterButton: {
      duration:       [0.2, 0.1, 2, 0.01],
